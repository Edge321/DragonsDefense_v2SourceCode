...
# Layout
Every folder besides the `Design` folder is code for my game. However, Unreal Blueprints are not included in this section. You can't really show that off as easy as C++ files.
## Design
